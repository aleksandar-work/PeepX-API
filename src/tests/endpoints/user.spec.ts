...
describe('=> API User Endpoint <=', () => {
    ...
    describe('=> createUser <=', () => {
        ...
        // Removed password validation check in accordance with
        // biz ops needing simpler passwords for users to enter
        ...
        it('=> should return an error if required data is missing or doesnt pass validation', async () => {
            ...
            // Removed temporarily for the above reason
    ...
    describe('=> getUsers <=', () => {
        ...
        it('=> should return an array of users', async () => {
            ...
            expect(response.body.response[0]).to.not.haveOwnProperty(
                'password',
            );
